...
const char* itemBaudRate    = "BaudRate";
...
const char* itemTrBaudRate    = "Скорость";
...
static BaudRateEnum baudRate = Rate9600;
static int param3 = 100;

int language = 0;

static EnumMenuValue<BaudRateEnum>::EnumItem BaudRateItems[] = { { Rate9600 }, { Rate57600 }, { Rate115200 }, };
static EnumMenuValue<BaudRateEnum> baudRateValue(&baudRate, BaudRateItems, 3);
...
//             id  |   parentId |           name |        translate |        value |      action
	...
	{    BaudRate,   Parameters,    itemBaudRate,    itemTrBaudRate, &baudRateValue,      nullptr, },
